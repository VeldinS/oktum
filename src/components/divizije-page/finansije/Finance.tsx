...
const Finance = () => {
    ...
    return (
        <div>
            ...
            <div className="my-component-finance" style={{backgroundImage:  `linear-gradient(rgba(0,0,0,0.55), rgba(0,0,0,.55)), url(${image3})`, backgroundAttachment: "fixed", backgroundSize: "cover", height: "max-content"}}>
