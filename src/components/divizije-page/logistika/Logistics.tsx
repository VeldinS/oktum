...
import image1 from "../../../images/logistics-page-background.webp";
import image2 from "../../../images/logo.webp";
import image3 from "../../../images/logistics-page-background2.webp";
import image4 from "../../../images/logistics-page-part1.webp";
import image5 from "../../../images/logistics-page-part2.webp";
import image6 from "../../../images/logistics-page-part3.webp";
...
const Logistics = () => {
    ...
    useEffect(() => {
        const agrarBackground = document.getElementById("logisticsBackground");
    ...
    return (
        <div>
            <div id={"logisticsBackground"} className={"about-page-main"} style={{backgroundImage:  `linear-gradient(rgba(0,0,0,0.7), rgba(0,0,0,.7)), url(${bgImage})`, backgroundSize: "cover", height: "100vh", backgroundPosition: "center center"}}>
                    ...
                    <div className={" header-row"}>
                        <nav className="navbar" >
                            <div id={"navbar-items"} className="navbar-items">
                                ...
                                <div className="navbar-item navbar-item1">
                                    <p onClick={() => navigate('/About')} className={"navbar-text1"}>O NAMA</p>
                                    <div className="dropdown-content">
                ...
                <div style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", height: "100%" }}>
                    <h1 className={"logistics-page-header"}  style={{ margin: 0, marginTop: "-200px" }}>{texts[language].logisticsPageMainHeading}</h1>
                </div>
            </div>
            ...
            <div className="my-component-logistics" style={{backgroundImage:  `linear-gradient(rgba(0,0,0,0.65), rgba(0,0,0,.65)), url(${image3})`, backgroundAttachment: "fixed", backgroundSize: "cover", height: "max-content"}}>
                <div className="general-info-logistics">
                    ...
                    <div className={"logistics-text"}>
                        <p>{texts[language].logisticsPageText1}</p>
                    </div>
                </div>

                <div className={"logistics-cards-desktop"}>
                    <DivisionCard title={texts[language].logisticsPageHeading2} imageSrc={image4} text={texts[language].logisticsPageText2}/>
                    <div className={"hor-line"}><hr/></div>
                    <DivisionCard1 title={texts[language].logisticsPageHeading3} imageSrc={image5} text={texts[language].logisticsPageText3}/>
                    <div className={"hor-line"}><hr/></div>
                    <DivisionCard title={texts[language].logisticsPageHeading4} imageSrc={image6} text={texts[language].logisticsPageText4}/>

                </div>

                <div className={"logistics-cards-mobile"}>
                    <DivisionCardMobile title={texts[language].logisticsPageHeading2} imageSrc={image4} text={texts[language].logisticsPageText2} readMore={texts[language].readMore}/>
                    <div className={"hor-line"}><hr/></div>
                    <DivisionCardMobile title={texts[language].logisticsPageHeading3} imageSrc={image5} text={texts[language].logisticsPageText3} readMore={texts[language].readMore}/>
                    <div className={"hor-line"}><hr/></div>
                    <DivisionCardMobile title={texts[language].logisticsPageHeading4} imageSrc={image6} text={texts[language].logisticsPageText4} readMore={texts[language].readMore}/>
                </div>
            </div>
