export const texts:any = {
    bosnian: {
        ...
        aboutText: "Od svog osnivanja 2016. godine, posvećeni smo pružanju najkvalitetnijih proizvoda našim kupcima.",
        ...
        //ABOUT PAGE
        aboutPageHeading1: "OD 2016...",
        aboutPageText1: "Od našeg osnivanja 2016. godine, posvećeni smo pružanju najkvalitetnijih proizvoda našim kupcima. Sami pokazatelj toga jeste to da smo za samo 6 godina postali vodeća kompanija u oblasti uvoza i prodaje žitarica na veliko.",
        aboutPageHeading2: "O NAŠOJ KOMPANIJI",
        aboutPageText2_1: "Naš primarni sektor je trgovina na veliko žitaricama, gdje nudimo širok asortiman proizvoda koji zadovoljavaju različite potrebe naših kupaca. Blisko sarađujemo sa poljoprivrednicima i dobavljačima kako bismo osigurali da su naši proizvodi najvišeg kvaliteta i da ispunjavaju naše stroge standarde održivosti i etike.",
        aboutPageText2_2: "Osim naše osnovne djelatnosti, proširili smo se i na još dva sektora – finansije i transport. Naš finansijski sektor pruža rješenja za financiranje našim klijentima, olakšavajući im kupovinu naših proizvoda. Naš transportni sektor ima desetine vlastitih kamiona, osiguravajući da se naši proizvodi bezbjedno i efikasno isporučuju kupcima širom zemlje.",
        ...
        aboutPageText4: "Osnovan 2016. godine, OKTUM je vodeća kompanija u trgovini i veleprodaji žitarica, kukuruza, soje, pšenice, raži i ječma.\n" +
            "Od 2022. godine OKTUM je glavni igrač u industriji i posvećen je pružanju proizvoda najvišeg kvaliteta po konkurentnim cijenama.\n" +
            "OKTUM se proširio na druga dva sektora – finansije i transport, pružajući svojim klijentima rješenja za finansiranje i transportne usluge.\n" +
            "Kompanija je posvećena održivosti i etičkim poslovnim praksama, blisko sarađujući sa dobavljačima kako bi osigurala odgovoran izvor svojih proizvoda.\n" +
            "Sa timom stručnjaka i posvećenošću inovacijama, OKTUM je spreman da nastavi da vodi industriju i pruža najbolje proizvode i usluge svojim kupcima.",
        aboutPageText4_1: "Osnovan 2016. godine, OKTUM je vodeća kompanija u trgovini i veleprodaji žitarica, kukuruza, soje, pšenice, raži i ječma",
        aboutPageText4_2: "Od 2022. godine OKTUM je glavni igrač u industriji i posvećen je pružanju proizvoda najvišeg kvaliteta po konkurentnim cijenama",
        aboutPageText4_3: "OKTUM se proširio na druga dva sektora – finansije i transport, pružajući svojim klijentima rješenja za finansiranje i transportne usluge",
        aboutPageText4_4: "Kompanija je posvećena održivosti i etičkim poslovnim praksama, blisko sarađujući sa dobavljačima kako bi osigurala odgovoran izvor svojih proizvoda",
        aboutPageText4_5: "Sa timom stručnjaka i posvećenošću inovacijama, OKTUM je spreman da nastavi da vodi industriju i pruža najbolje proizvode i usluge svojim kupcima",
        ...
        agrarPageText1: "Naša Agrar divizija posvećena je bliskoj saradnji sa poljoprivrednicima i dobavljačima kako bi osigurali da naši proizvodi budu najviše kvalitete i da se pridržavaju naših strogi standardi za održivost i etiku. Posvećeni smo odgovornom nabavljanju naših proizvoda i smanjenju utjecaja na okoliš kroz naše poslovanje. S fokusom na kvalitetu i održivosti, ponosno nudimo širok spektar poljoprivrednih proizvoda koji zadovoljavaju raznolike potrebe naših kupaca.",
        agrarPageHeading2: "KUKURUZ",
        agrarPageText2: "Kukuruz je jedan od glavnih proizvoda koje nudi naša kompanija. Blisko sarađujemo sa poljoprivrednicima i dobavljačima kako bi osigurali da je naš kukuruz najviše kvalitete i da zadovoljava kako naše, tako i standarde naših kupaca.",
        agrarPageHeading3: "SOJA",
        agrarPageText3: "OKTUM je glavni dobavljač visokokvalitetne sojine sačme i ostalih sojinih proizvoda za preduzeća i trgovce na veliko širom zemlje. Kompanija nabavlja soju od provjerenih dobavljača i primjenjuje rigorozne procese testiranja i inspekcije kako bi osigurala da svi proizvodi zadovoljavaju njene stroge standarde kvaliteta. Oktum također nudi fleksibilne mogućnosti financiranja i efikasna logistička rješenja kako bi osigurala pravovremenu isporuku soje svojim klijentima.",
        agrarPageHeading5: "ULJE",
        agrarPageText5: "Naša paleta jestivih ulja obuhvata razne vrste ulja, kao što su suncokretovo ulje, ulje od uljane repice, maslinovo ulje, kukuruzno ulje i mnoge druge. Svi naši proizvodi su pažljivo odabrani od renomiranih dobavljača i podvrgnuti rigoroznim kontrolama kvalitete kako bismo osigurali da ispunjavaju naše visoke standarde.",
        ...
        agrarPageHeading4: "OSTALI PROIZVODI",
        agrarPageText4: "Pored merkantilnog kukuruza i soje, također se bavimo prodajom ostalih proizvoda, kao što su: pšenica, ječam, sojino ulje, suncokret, suncokretovo ulje, kukuruzno ulje, monokalcijev fosfat, te mnogobrojni ostali proizvodi.",
        ...
        financePageHeading2: "ZAJMOVI, FINANSIRANJE I FAKTURISANJE",
        financePageText2: "Naše finansijske opcije su prilagođene jedinstvenim potrebama svakog od naših klijenata i uključuju opcije kao što su kratkoročni zajmovi, trgovinsko finansiranje i fakturisanje faktura.",
        financePageHeading5: "FINANSIRANJE GRAĐEVISNKIH PROJEKATA",
        financePageText5: "OKTUM pruža fleksibilna finansijska rješenja za podršku finansiranju građevinskih objekata. Razumijemo da građevinski projekti zahtijevaju značajna finansijska ulaganja, stoga smo tu da pomognemo našim klijentima da ostvare svoje građevinske ambicije. OKTUM također ima bogato iskustvo u saradnji sa građevinskim preduzećima, investitorima i drugim relevantnim akterima u industriji. To nam omogućava da pružimo strateške savjete i podršku našim klijentima kako bi ostvarili uspješne građevinske projekte.",
        ...
        logisticsPageText3: "Posedujemo flotu od desetina vozila, opremljenih najsavremenijim sistemima za praćenje i komunikaciju, kako bismo osigurali da se proizvodi naših klijenata transportuju bezbjedno i na vrijme. Naše usluge skladištenja uključuju skladištenje s kontroliranom temperaturom, sigurno upravljanje zalihama i usluge ispunjenja, sve dizajnirane da zadovolje jedinstvene potrebe svakog našeg klijenta.",
        logisticsPageHeading4: "LOGISTIČKA RJEŠENJA",
        logisticsPageText4: " U OKTUM-u smo posvećeni pružanju izuzetne korisničke usluge i osiguravanju da naši klijenti imaju podršku koja im je potrebna za uspjeh. Naša logistička rješenja su dizajnirana da pomognu našim klijentima da pojednostave svoj lanac nabavke, smanje troškove i poboljšaju svoju ukupnu operativnu efikasnost. Vjerujemo da pružanjem pouzdanih i isplativih logističkih usluga možemo pomoći našim klijentima da ostvare svoje poslovne ciljeve i uspiju u svojim djelatnostima.",
    ...
    english: {
        ...
        aboutText: "Since our establishment in 2016, we have been committed to providing the highest quality products to our customers.",
        ...
        //ABOUT PAGE
        aboutPageHeading1: "SINCE 2016...",
        aboutPageText1: "Since our establishment in 2016, we have been committed to providing the highest quality products to our customers. An indicator of this is that in just 6 years, we have become the leading company in the field of importing and selling cereals in bulk.",
        ...
        aboutPageText2_1: "Our primary sector is wholesale trading of cereals, where we offer a wide range of products to meet the diverse needs of our customers. We work closely with farmers and suppliers to ensure that our products are of the highest quality and that they meet our strict sustainability and ethical standards.",
        aboutPageText2_2: "In addition to our core business, we have expanded into two other sectors - finance and transport. Our finance sector provides financing solutions to our customers, making it easier for them to purchase our products. Our transport sector boasts dozens of our own trucks, ensuring that our products are delivered safely and efficiently to customers across the country.",
        ...
        aboutPageText4: "Established in 2016, OKTUM is a leading company in the trading and wholesale of cereals, corn, soybean, wheat, rye, and barley. Since 2022, OKTUM has been a major player in the industry and is committed to providing the highest quality products at competitive prices.\n" +
            "OKTUM has expanded into two other sectors - finance and transport, providing financing solutions and transport services to its customers.\n" +
            "The company is committed to sustainability and ethical business practices, working closely with suppliers to ensure the responsible sourcing of its products.\n" +
            "With a team of experts and a commitment to innovation, OKTUM is poised to continue leading the industry and providing the best products and services to its customers.",
        aboutPageText4_1: "Established in 2016, OKTUM is a leading company in the trading and wholesale of cereals, corn, soybean, wheat, rye, and barley",
        aboutPageText4_2: "Since 2022, OKTUM has been a major player in the industry and is committed to providing the highest quality products at competitive prices",
        aboutPageText4_3: "OKTUM has expanded into two other sectors - finance and transport, providing financing solutions and transport services to its customers",
        ...
        agrarPageText1: "Our Agrar division is dedicated to working closely with farmers and suppliers to ensure that our products are of the highest quality and that they meet our strict sustainability and ethical standards. We are committed to sourcing our products responsibly and reducing the environmental impact of our operations. With our focus on quality and sustainability, we are proud to offer a wide range of agricultural products to meet the diverse needs of our customers.",
        agrarPageHeading2: "CORN",
        agrarPageText2: "Corn is one of the primary products offered by our company. We work closely with farmers and suppliers to ensure that our corn is of the highest quality and meets our and customers strict standards.",
        agrarPageHeading3: "SOYBEAN",
        agrarPageText3: "OKTUM is a major supplier of high-quality soybeans to businesses and retailers across the country. The company sources soybeans from trusted suppliers and employs rigorous testing and inspection processes to ensure that all products meet its strict quality standards. Oktum also provides flexible financing options and efficient logistics solutions to ensure timely delivery of soybeans to its clients.",
        agrarPageHeading5: "OIL",
        agrarPageText5: "Our range of edible oils includes various types of oils, such as sunflower oil, rapeseed oil, olive oil, corn oil and many others. All our products are carefully selected from reputable suppliers and undergo rigorous quality controls to ensure they meet our high standards.",
        ...
        agrarPageHeading4: "OTHER PRODUCTS",
        agrarPageText4: "In addition to commercial corn and soybeans, we also sell other products, such as: wheat, barley, soybean oil, sunflower, sunflower oil, corn oil, monocalcium phosphate, and many other products.",
        ...
        logisticsPageText3: "We operate a fleet of dozens of vehicles, equipped with state-of-the-art tracking and communication systems, to ensure that our clients' products are transported securely and on time. Our warehousing services include temperature-controlled storage, secure inventory management, and fulfillment services, all designed to meet the unique needs of each of our clients.",
